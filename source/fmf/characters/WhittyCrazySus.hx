...
class WhittyCrazySus extends Boyfriend
{
	...
	{
		var tex = Paths.getSparrowAtlas('whitty/WhittyCrazy', 'mods');

		var tex2 = Paths.getSparrowAtlas('whitty/WhittyCrazy_miss', 'mods');
	...
	public override function createAnimations():Void
	{
		...
		animation.addByPrefix('singUPmiss', 'Whitty Sing Note UP MISS', 1, false);
		animation.addByPrefix('singRIGHTmiss', 'whitty sing note right MISS', 1, false);
		animation.addByPrefix('singLEFTmiss', 'Whitty Sing Note LEFT MISS', 1, false);
		animation.addByPrefix('singDOWNmiss', 'Whitty Sing Note DOWN MISS', 1, false);
