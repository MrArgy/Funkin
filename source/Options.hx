...
class PcOption extends Option
{
    ...
    static public var pcList:Array<String> = ['Boyfriend','TrickyMask','TrickyEx', 'TrickyHell', 'Tricky','Garcello', 'GarcelloTired', 'GarcelloDead', 'GarcelloGhosty', "TabiMad", 'Ruv', 'Sarv', 'Littleman', 'Pico', 'Mom', 'Dad', 'IIMarky'];
